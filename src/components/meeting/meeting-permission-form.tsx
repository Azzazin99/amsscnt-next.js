...
import type { DistrictStaffOption } from "@/lib/meeting/queries";

type MeetingPermissionFormProps = {
...
export function MeetingPermissionForm({
  action,
  staffOptions,
  title,
  cancelHref,
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto max-w-lg space-y-4">
      ...
      <fieldset className="space-y-2">
        <legend className="text-sm font-medium">เจ้าหน้าที่ / อนุมัติ (p1)</legend>
        <p className="text-xs text-muted-foreground">
          ดูรายการและพิจารณาอนุมัติการจองห้องประชุม
        </p>
