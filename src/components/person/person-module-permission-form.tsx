...
type PersonModulePermissionFormProps = {
...
export function PersonModulePermissionForm({
  action,
  staffOptions,
  title,
  cancelHref,
  defaultValues,
  lockUser = false,
}: PersonModulePermissionFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto max-w-lg space-y-4">
      ...
      <BoolRadioGroup
        ...
        hint="ดูรายชื่อบุคลากร"
      />
      <BoolRadioGroup
        name="p2"
        label="บันทึก / แก้ไข (p2)"
        defaultValue={defaultValues?.p2 ?? false}
      />
      <BoolRadioGroup
        name="p3"
        label="ปิดใช้งาน (p3)"
        defaultValue={defaultValues?.p3 ?? false}
      />
