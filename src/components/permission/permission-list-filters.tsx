...
type PermissionListFiltersProps = {
  q: string;
  grant: string;
};
...
export function PermissionListFilters({ q, grant }: PermissionListFiltersProps) {
  ...
  return (
    ...
    >
      <div className="min-w-[200px] flex-1 space-y-1">
        <label htmlFor="perm-q" className="text-xs font-medium text-muted-foreground">
          ค้นหา (ชื่อ / เรื่อง / สถานที่)
        </label>
        <input
          id="perm-q"
          name="q"
