...
type PermissionApproveFormProps = {
...
export function PermissionApproveForm({ action }: PermissionApproveFormProps) {
      ...
      <fieldset className="space-y-2">
        ...
        <div className="flex flex-wrap gap-6">
          <label className="flex cursor-pointer items-center gap-2 text-sm">
            <input type="radio" name="grantStatus" value="1" required />
            อนุมัติ
          </label>
          <label className="flex cursor-pointer items-center gap-2 text-sm">
            <input type="radio" name="grantStatus" value="0" required />
            ไม่อนุมัติ
          </label>
        </div>
      </fieldset>
