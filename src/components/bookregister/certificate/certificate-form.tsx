...
export type CertificateFormActionResult =
  | { ok: true; id?: number }
...
type CertificateFormProps = {
  ...
  action: (
    formData: FormData,
  ) => Promise<CertificateFormActionResult | void>;
  defaultValues?: CertificateFormDefaults;
  mode: "create" | "edit";
};
    ...
    >
      ...
      <div className="space-y-2">
        <label htmlFor="signdate" className="text-sm font-medium">
          ลงวันที่ <span className="text-destructive">*</span>
        </label>
        <ThaiDatePicker
          id="signdate"
          name="signdate"
      ...
      <div className="space-y-3 rounded-xl border bg-muted/30 p-4">
        ...
        {hasExistingFile && defaultValues?.certificateId ? (
          <p className="text-sm">
            ไฟล์ปัจจุบัน:{" "}
            <Link
              href={`/api/bookregister/certificate/${defaultValues.certificateId}/file`}
