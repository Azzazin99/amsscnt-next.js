...
export const CERTIFICATE_COLUMN_SIZING_STORAGE_KEY =
  "amss:bookregister-certificate:column-sizing:v1";

export const DEFAULT_CERTIFICATE_COLUMN_SIZING: BookregisterColumnSizing =
  {
    registerNumber: 56,
    year: 64,
    bookNo: 88,
