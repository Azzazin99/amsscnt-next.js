...
export function PermissionForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto max-w-lg space-y-4">
      ...
      <div className="space-y-2">
        ...
        {lockUser && defaultValues ? (
          <>
            ...
            <p className={cn(inputClass, "bg-muted/40")}>
      ...
      <BoolRadioGroup
        name="p1"
        label="อนุญาตให้เป็นเจ้าหน้าที่ (ดูทะเบียน)"
        defaultValue={defaultValues?.p1 !== false}
      />
      <BoolRadioGroup
        name="p2"
        label="บันทึก / แก้ไขทะเบียน"
        defaultValue={defaultValues?.p2 === true}
      />
      <BoolRadioGroup
        name="p3"
        label="ลบทะเบียน"
        defaultValue={defaultValues?.p3 === true}
      />
      <BoolRadioGroup
        name="canViewSecret"
        label="ดูหนังสือลับ"
        defaultValue={defaultValues?.canViewSecret === true}
        hint="ตามระเบียบ 2546 — ผู้ไม่มีสิทธิ์จะไม่เห็นรายการหนังสือลับในรายการทะเบียน"
      />
