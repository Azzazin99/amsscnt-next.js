...
type LeaveCancellationListFiltersProps = {
  q: string;
...
export function LeaveCancellationListFilters({
  q,
  leaveType,
  grant,
}: LeaveCancellationListFiltersProps) {
  ...
  return (
    ...
    >
      <div className="min-w-[200px] flex-1 space-y-1">
        <label htmlFor="cancel-q" className="text-xs font-medium text-muted-foreground">
          ค้นหา (ชื่อ / เลขบัตร)
        </label>
        <input
          id="cancel-q"
