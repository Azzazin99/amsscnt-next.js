  ...
  return (
    <section className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h2 className="text-lg font-semibold text-primary">สิทธิ์เจ้าหน้าที่</h2>
        <Link
          href="/modules/meeting/permissions/new"
        ...
        <table className="w-full min-w-[480px] text-sm">
          <thead>
            <tr className="border-b bg-muted/50 text-left">
              ...
              <th className="px-3 py-3 text-center font-medium">p1 เจ้าหน้าที่</th>
            ...
            {rows.length === 0 ? (
              ...
              rows.map((row, index) => (
                ...
                >
                  ...
                  <td className="px-3 py-2.5 text-center">
                    <MeetingPermissionDeleteButton id={row.id} />
                  </td>
                  <td className="px-3 py-2.5 text-center">
                    <Link
                      href={`/modules/meeting/permissions/${row.id}/edit`}
