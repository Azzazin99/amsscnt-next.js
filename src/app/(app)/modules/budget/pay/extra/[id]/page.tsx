...
export default async function BudgetPayExtraDetailPage({ params }: Props) {
  ...
  async function handleDelete() {
    "use server";
    await deleteBudgetKindPay("extra", id);
  }
  ...
  return (
    <BudgetMainDetailView
      row={row}
      mode="pay"
      basePath="/modules/budget/pay/extra"
      backLabel="กลับทะเบียนจ่ายเงินนอกงบประมาณ"
      canWrite={canWriteBudgetPay(user, perms, "extra")}
