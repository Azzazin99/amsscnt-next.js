...
export default async function BudgetReceiveExtraDetailPage({ params }: Props) {
  ...
  async function handleDelete() {
    "use server";
    await deleteBudgetKindReceive("extra", id);
  }
  ...
  return (
    <BudgetMainDetailView
      row={row}
      mode="receive"
      basePath="/modules/budget/receive/extra"
      backLabel="กลับทะเบียนรับเงินนอกงบประมาณ"
      canWrite={canReceiveBudgetByKind(user, perms, "extra")}
