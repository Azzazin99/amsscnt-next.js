...
export default async function OwnerResultsPage({ searchParams }: Props) {
  ...
  return (
    <section className="space-y-4">
      <h2 className="text-lg font-semibold text-primary">
        รายงานผลการดำเนินงาน {yearRow.budgetYear}
      </h2>

      <PlanReportFilters
        basePath="/modules/plan/reports/owner-results"
        years={years}
