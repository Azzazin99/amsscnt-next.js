...
export default async function PersonSchoolPositionUpdateCodePage() {
    ...
    <div className="mx-auto max-w-2xl space-y-6 pt-4">
      <div>
        <h2 className="text-xl font-semibold text-primary">
          ปรับปรุงรหัสตำแหน่งของข้อมูลครูและบุคลากรในสถานศึกษา
        </h2>
        <p className="text-sm text-muted-foreground">
          เครื่องมือเปลี่ยนรหัสตำแหน่งเดิมเป็นรหัสตำแหน่งใหม่สำหรับบุคลากรทั้งหมดในสถานศึกษา
        </p>
      </div>

      <form className="space-y-4 rounded-xl border bg-card p-6 shadow-sm">
        <div className="space-y-2">
          <label htmlFor="oldCode" className="block text-sm font-medium">
            รหัสตำแหน่งเดิม
          </label>
          <input
            id="oldCode"
        ...
        <div className="space-y-2">
          <label htmlFor="newCode" className="block text-sm font-medium">
            รหัสตำแหน่งใหม่
          </label>
          <input
            id="newCode"
