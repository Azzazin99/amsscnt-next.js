...
const IMPORT_SCHOOL_INSTRUCTIONS = [
  "เตรียมข้อมูลในไฟล์ Excel โดยให้แถวแรกเป็นชื่อหัวสดมภ์ (Header) และแถวที่ 2 เป็นต้นไปเป็นข้อมูลบุคลากรแต่ละคน",
  "คอลัมน์ประกอบด้วย 6 คอลัมน์: 1.เลขประจำตัวประชาชน, 2.คำนำหน้าชื่อ, 3.ชื่อ, 4.นามสกุล, 5.รหัสตำแหน่ง, 6.รหัสสถานศึกษา",
  "สามารถอ้างอิงรหัสตำแหน่งได้จากเมนู 'กำหนดตำแหน่งครูและบุคลากรในสถานศึกษา' และรหัสสถานศึกษาจากเมนู 'ชื่อและรหัสสถานศึกษา'",
...
const SAMPLE_COLUMNS = [
  ...
  { col: 2, name: "คำนำหน้าชื่อ", example: "นางสาว" },
  { col: 3, name: "ชื่อ", example: "สมศรี" },
  { col: 4, name: "นามสกุล", example: "รักเรียน" },
  { col: 5, name: "รหัสตำแหน่ง", example: "3" },
  { col: 6, name: "รหัสสถานศึกษา", example: "17010001" },
];

export default async function PersonImportSchoolTextSettingsPage() {
    ...
    <div className="mx-auto max-w-3xl space-y-6 pt-2">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4 border-b pb-4">
        <div>
          <h2 className="text-xl font-semibold text-primary">
            นำเข้าข้อมูลครูและบุคลากรในสถานศึกษา
          </h2>
          <p className="mt-1 text-sm text-muted-foreground">
            อัปโหลดไฟล์ข้อความ (Text File UTF-8) เพื่อนำเข้าข้อมูลบุคลากรประจำสถานศึกษา/โรงเรียน เข้าสู่ระบบ
          </p>
        </div>
        <a
          href="/templates/person_school_import_template.txt"
          download="person_school_import_template.txt"
          className={cn(
      ...
      <div className="rounded-xl border bg-card p-5 shadow-sm space-y-3">
        <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
          ...
          <h3>ตัวอย่างโครงสร้างคอลัมน์ไฟล์นำเข้า (6 คอลัมน์)</h3>
        </div>
      ...
      <div className="rounded-xl border bg-card p-5 shadow-sm space-y-3">
        ...
        <ol className="space-y-2 text-xs text-muted-foreground">
          {IMPORT_SCHOOL_INSTRUCTIONS.map((text, idx) => (
