#!/usr/bin/env bash
# Extract legacy plan_* tables from AMSS_reduced.sql and load them into MySQL.
# Usage: bash scripts/load-legacy-plan.sh
...
echo "Extracting legacy plan tables from $DUMP..."
...
echo "Done. Legacy plan tables loaded."
