#!/usr/bin/env bash
# Extract legacy la_* tables from AMSS_reduced.sql and load them into MySQL.
# Usage: bash scripts/load-legacy-leave.sh
...
echo "Extracting legacy leave tables from $DUMP..."
...
echo "Done. Legacy leave tables loaded."
echo "Now run: npm run db:import-leave -- --fresh-leave"
