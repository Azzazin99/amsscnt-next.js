#!/usr/bin/env bash
# Extract legacy mail_* tables from AMSS_reduced.sql and load them into MySQL.
# Usage: bash scripts/load-legacy-mail.sh
...
echo "Extracting legacy mail tables from $DUMP..."
...
echo "Done. Legacy mail tables loaded."
echo "Now run: npx tsx scripts/import/import-mail-standalone.ts"
