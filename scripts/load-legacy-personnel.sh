#!/usr/bin/env bash
# Extract legacy person_main and person_sch_main tables from AMSS.sql (or AMSS_reduced.sql) and load them into MySQL.
# Usage: bash scripts/load-legacy-personnel.sh
...
echo "Extracting legacy personnel tables from $DUMP..."
...
echo "Done. Legacy personnel tables loaded into MySQL."
